...
playPodcast.forEach(itemPodcast =>{
  itemPodcast.addEventListener('click', (e) =>{
      ...
      playPodcast.forEach(el=>{ el.classList.remove('play-podcast'); });
...
let translationMobile = document.querySelector(".header__translation-mobile-button");
...
translationMobile.addEventListener("click",

  function () {

    translation.classList.toggle("header__block-translation-mobile--active");
    translationButtonContainer.classList.toggle("header__down-container--active")
...
tabsBtn.forEach(function (element) {
  element.addEventListener('click', function (e) {
    ...
    tabsBtn.forEach(function (tabsBtn) { tabsBtn.classList.remove('drop-down__content-button--active') });
    e.currentTarget.classList.add('drop-down__content-button--active');

    tabsContent.forEach(function (e) { e.classList.remove('guest__card--active') });
